...
<div>
    <div class="sidebar mb-5 mb-xl-0 row">
                            <div class="col-md-6 col-lg-6 col-xl-12 sidebar-widget">
                                <h3 class="mb-3">{{ authorSidebarData.sidebarWidget.title }}</h3>
                                ...
                                <div class="follow-wrap mt-3">
                                    <p class="mb-1 text-black fw-semibold">{{ authorSidebarData.sidebarWidget.followText }}</p>
                                    <div class="avatar-group mb-3">
                                        <a :href="item.path" v-for="(item, i) in avatars" :key="i"><img :src="item.avatar" alt=""></a>
                                    </div>
                                    <a href="#" class="btn-link sidebar-btn-link" data-bs-toggle="modal" data-bs-target="#followersModal">{{ authorSidebarData.sidebarWidget.btnText  }}</a>
                                </div>
                            </div><!-- end col -->
                            <div class="col-md-6 col-lg-6 col-xl-12 sidebar-widget">
                                <h3 class="mb-3">{{ authorSidebarData.sidebarWidgetTwo.title }}</h3>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-12 sidebar-widget">
                                <h3 class="mb-2">{{ authorSidebarData.sidebarWidgetThree.title }}</h3>
                ...
                <div class="modal-header">
                    <ul class="nav nav-tabs nav-tabs-s1 nav-tabs--s1" id="myTabTwo" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="following-tab" data-bs-toggle="tab" data-bs-target="#following" type="button" role="tab" aria-controls="following" aria-selected="false">{{ followersModal.btnText}}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="followers-tab" data-bs-toggle="tab" data-bs-target="#followers" type="button" role="tab" aria-controls="followers" aria-selected="true">{{ followersModal.btnTextTwo }}</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContentTwo">
                        <div class="tab-pane fade" id="following" role="tabpanel" aria-labelledby="following-tab">
                            <div class="item-detail-tab-wrap">
                                <div class="card-follow d-flex align-items-center justify-content-between mb-3" v-for="item in followersModal.followingList" :key="item.id">
                        ...
                        <div class="tab-pane fade show active" id="followers" role="tabpanel" aria-labelledby="followers-tab">
                            <div class="item-detail-tab-wrap">
                                <div class="card-follow d-flex align-items-center justify-content-between mb-3" v-for="item in followersModal.followerList" :key="item.id">
                                    <div class="d-flex align-items-center">
                                        <a :href="item.path" class="avatar flex-shrink-0 me-2">
                                            <img :src="item.avatar" alt="avatar">
                                        </a>
